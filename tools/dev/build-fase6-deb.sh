...
PUBLISH="${MIASTRO_PUBLISH_DIR:-$ROOT/artifacts/publish/fase6-linux-x64}"
OUT="$ROOT/artifacts/deb"
STAGE="$ROOT/artifacts/package/fase6-deb"

VERSION="${MIASTRO_DEB_VERSION:-0.6.0~phase6-1}"
PACKAGE="miastro"
ARCH="amd64"
